...
class DiagnosisProvider with ChangeNotifier {
  ...
  Future<List<DiagnosisModel>> getDiagnoses(List<CaseModel> cases) async {
    ...
    //     message: "STATE_TRANSITION: REC_VEHICLE_AND_PROC_METADATA --- (processed_metadata) ---> PROC_CUSTOMER_COMPLAINTS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: PROC_CUSTOMER_COMPLAINTS --- (no_complaints) ---> READ_OBD_DATA_AND_GEN_ONTOLOGY_INSTANCES",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    ...
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: READ_OBD_DATA_AND_GEN_ONTOLOGY_INSTANCES --- (processed_OBD_data) ---> RETRIEVE_HISTORICAL_DATA",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: RETRIEVE_HISTORICAL_DATA --- (processed_all_data) ---> ESTABLISH_INITIAL_HYPOTHESIS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: ESTABLISH_INITIAL_HYPOTHESIS --- (established_init_hypothesis) ---> DIAGNOSIS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: SELECT_BEST_UNUSED_ERROR_CODE_INSTANCE --- (no_matching_selected_best_instance) ---> SUGGEST_SUSPECT_COMPONENTS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: SUGGEST_SUSPECT_COMPONENTS --- (provided_suggestions) ---> CLASSIFY_COMPONENTS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    ...
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "HEATMAPS: boost_pressure_control_valve [ANOMALY - SCORE: 0.0029614063]",
    //     attachment: "666abcf93d9fdf79fb6c11b5",
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: CLASSIFY_COMPONENTS --- (detected_anomalies) ---> ISOLATE_PROBLEM_CHECK_EFFECTIVE_RADIUS",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    ...
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: ISOLATE_PROBLEM_CHECK_EFFECTIVE_RADIUS --- (isolated_problem) ---> PROVIDE_DIAG_AND_SHOW_TRACE",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "FAULT_PATHS: ['boost_pressure_solenoid_valve -> boost_pressure_control_valve']",
    //     attachment: null,
    //   ),
    //   StateMachineLogEntryModel(
    //     message: "STATE_TRANSITION: PROVIDE_DIAG_AND_SHOW_TRACE --- (uploaded_diag) ---> diag",
    //     attachment: null,
    //   )
    //     ],
    //     todos: [],
