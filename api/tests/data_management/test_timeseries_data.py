...
class TestGridFSSignalStore:
    ...
    async def test_create_and_get(self, motor_db):
        # Hack: Cannot use conftest signal_bucket here or test will fail
        signal_bucket = motor_asyncio.AsyncIOMotorGridFSBucket(
            motor_db, bucket_name="signals-pytest"
        )
