...
class TestOmniviewCSVReader:
    def test_read_file(self, omniview_csv_file):
        # convert file
        ...
        assert result["device_specs"]["device_id"] == "E46920935F320D2D"

    def test_read_sin_file(self, omniview_sin_csv_file):
        # convert file
        reader = OmniviewCSVReader()
        ...
        assert result["device_specs"]["type"] == "omniscope"
        assert result["device_specs"]["device_id"] == "E46228B163272D25"

    @pytest.mark.parametrize(
        "file", ["picoscope_1ch_eng_csv_file", "picoscope_4ch_eng_csv_file"]
    )
